					...
					<header id="header">
						...
						<nav>
							<ul>
								...
								<li><a href="#nouvelle commande">nouvelle commande</a></li>
								<li><a href="#commandes en cours">commande en cours</a></li>
						...
						<!-- inscription -->
							<article id="sign-in">
								...
								<form method="post" action="inscription.php">
									...
									<ul class="actions">
										<li><input type="submit" value="sigh-in" class="primary" /></li>
